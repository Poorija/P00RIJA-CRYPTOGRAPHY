...
dependencies {
    ...
    // Looking for mail on a phone with no UnifiedPush distributor. The
    // platform will not run this more than once every fifteen minutes and
    // under Doze rather less, which is why it is the fallback and not the
    // plan.
